...
local filemanager       = "termite -e vifm"
local mailclient        = "termite -e neomutt"
local mediaplayer       = ""
...
--        {description = "dropdown terminal" , group = "function keys"}),
    ...
    awful.key({ modkey }, "h", function () awful.util.spawn( "termite -T 'htop task manager' -e htop" ) end,
        {description = "htop", group = "super"}),
    awful.key({ modkey }, "r", function () awful.util.spawn( filemanager ) end,
        {description = "file manager", group = "super"}),
    awful.key({ modkey }, "e", function () awful.util.spawn( mailclient ) end,
        {description = mailclient , group = "super" }),
    awful.key({ modkey }, "t", function () awful.util.spawn( terminal ) end,
        {description = "terminal", group = "super"}),
    awful.key({ modkey }, "v", function () awful.util.spawn( "termite -e pulsemixer" ) end,
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot -s 'Core-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f /home/andrew/image'") end,
