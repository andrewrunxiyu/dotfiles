...
" Compile groff ms docs
"	autocmd BufWritePost *.ms !groff -e -ms -Tpdf % > /tmp/a.pdf
...
set guifont=SourceCodePro:h20
map <leader>0 :set guifont=SourceCodePro:h40<CR>
map <leader>9 :set guifont=SourceCodePro:h30<CR>
map <leader>8 :set guifont=SourceCodePro:h20<CR>
map <leader>7 :set guifont=SourceCodePro:h15<CR>
